...
angular.module('getphoto.narrationEngine', [])
.factory('NarrationEngine', ['$q', '$http', function($q, $http) {
  ...
  var NarrationEngine = function() {
    ...
    this.busy = false;
    this.id = 'n';
    this.narrationUrl = 'http://getphoto.net:7100/narrations/';
    this.narrationPageUrl = 'http://getphoto.net:7100/narration-page/';
    this.narrationReferralUrl = 'http://getphoto.net:7100/narration/';
  };
